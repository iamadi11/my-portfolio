...
export const EXPERIENCE: ExperienceEntry[] = [
    {
        ...
        color: '#7aa2ff',
        bullets: [
            'Own & maintain Risk WebApp platform serving enterprise merchants processing millions of tx/month.',
            'Architected configurable rule engine for real-time transaction blocking & flagging.',
            'Enhanced Video KYC reliability with reconnection flows — 30% fewer failed sessions.',
        ],
    ...
    },
    {
        ...
        color: '#b690ff',
        bullets: [
            'Led migration of legacy back-office to React — 3× faster feature velocity.',
            'Implemented PWA with offline support — 50% faster page loads.',
        ],
        tech: ['React', 'Next.js', 'React Query', 'Tailwind', 'Node'],
    },
    {
        role: 'SDE I → II',
        company: 'Tata 1mg',
        ...
        color: '#7ee5ff',
        bullets: [
            'Polygon-based serviceability engine — 15-min & 1-hr delivery zones.',
            'Centralized Node microservice for invoices — 60% less duplication.',
            'Realtime notifications via WebPush/Redis/SSE — SLA breaches 70% → 15%.',
            'Build pipeline: 15 min → 3 min (80% faster).',
        ],
        tech: ['React', 'Node', 'Redis', 'Google Maps', 'Turborepo'],
    },
];
