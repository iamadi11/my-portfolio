...
const DetailsCard: React.FC = () => {
    ...
    const item = {
        ...
        show: {
            opacity: 1,
            y: 0,
            transition: reduce ? { duration: 0 } : { type: 'spring' as const, stiffness: 420, damping: 32 },
        },
    };
        ...
        >
            ...
            >
                <motion.div variants={item} className="text-xl font-semibold text-gray-400">
                    Hello{' '}
                    <span className={clsx('inline-block origin-[70%_70%]', !reduce && 'animate-wave')}>
                        👋
                    </span>
                    ,
                </motion.div>
            ...
            <motion.div
                ...
                transition={
                    reduce ? { duration: 0 } : { type: 'spring', stiffness: 380, damping: 28, delay: 0.12 }
                }
            >
                <Image
                    src="/profile_pic.jpg"
